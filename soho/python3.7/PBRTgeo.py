...
class OutputGeo(object):
    ...
    def save_ply(self, path):
        ...
        with open(path, "wb") as f_handle:
            ...
            if self.has_N:
                tmp = array.array("f")
                tmp.frombytes(self.gdp.pointFloatAttribValuesAsString("N"))
                data_pool[offset::num_elements] = tmp[0::3]
                offset += 1
                data_pool[offset::num_elements] = tmp[1::3]
                offset += 1
            ...
            if self.has_uv:
                tmp = array.array("f")
                tmp.frombytes(self.gdp.pointFloatAttribValuesAsString("uv"))
                data_pool[offset::num_elements] = tmp[0::3]
                offset += 1
                data_pool[offset::num_elements] = tmp[1::3]
                offset += 1
            ...
            if self.has_faceIndices:
                tmp = array.array("i")
                tmp.frombytes(self.gdp.primIntAttribValuesAsString("faceIndices"))
