...
def smoke_prim_wrangler(grids, paramset=None, properties=None):
    ...
    for grid in grids:
        ...
        if isinstance(grid, FloatGrid):
            ...
            sigma_a_voxeldata.fromstring(grid.sigma_a.allVoxelsAsString())
            sigma_s_voxeldata.fromstring(grid.sigma_s.allVoxelsAsString())
            ...
            tmp_voxeldata.fromstring(grid.r.allVoxelsAsString())
            ...
            # Set the g values
            tmp_voxeldata.fromstring(grid.g.allVoxelsAsString())
            voxeldata[1::3] = tmp_voxeldata
            del tmp_voxeldata[:]

            # And last, the b values
            tmp_voxeldata.fromstring(grid.b.allVoxelsAsString())
